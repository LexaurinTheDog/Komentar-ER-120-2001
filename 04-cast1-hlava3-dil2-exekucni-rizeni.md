# HLAVA III — Díl 2 — Exekuční řízení (§ 35 — § 57)

Díl 2 je **vlastním tělem procesního exekučního práva**. Pokrývá celý životní cyklus exekuce od podání návrhu po její skončení — zahájení, účastníky, návrh, exekuční titul, pověření soudem, vyrozumění s **generálním inhibitoriem**, exekuční příkaz, **odklad**, **zastavení** (vč. zastavení marné exekuce po 6 letech podle novely 2021/286 Sb.), doručování. Procesně se opírá o **subsidiární použití OSŘ** (§ 52 odst. 1) — pokud EŘ nestanoví jinak, použijí se přiměřeně ustanovení Části šesté OSŘ o výkonu rozhodnutí.

**Systematicky** se Díl 2 člení do několika fází:

| Fáze | Paragrafy | Klíčové instituty |
|---|---|---|
| **Zahájení** | § 35, § 35a, § 35b | Návrh, rejstřík zahájených exekucí (RZE) |
| **Účastníci a návrh** | § 36, § 37, § 38, § 39 | Oprávněný/povinný/manžel, náležitosti návrhu, vady |
| **Exekuční titul** | § 40, § 41, § 42, § 43 | 6 typů titulů, SJM, podmíněné tituly |
| **Pověření soudem** | § 43a | Lhůty 15+15 dnů, obsah pověření, pokyn k zamítnutí |
| **Vstup do řízení** | § 44, § 44a, § 44b, § 44c | Vyrozumění, **generální inhibitorium**, změna exekutora |
| **Soud a postup** | § 45, § 46 | Místní příslušnost, povinnost rychlosti, zvláštní účet |
| **Exekuční příkaz** | § 47, § 48, § 49, § 50 | Volba způsobu, náležitosti, součinnost účastníků |
| **Procesní rámec** | § 51, § 52, § 53, § 55b, § 55c | Zánik pověření, subsidiarita OSŘ, záznam volání, rozhodování, odvolání |
| **Odklad a zastavení** | § 54, § 55, § 55a | Odklad (vč. nového odkladu při srážkách), zastavení po 6 letech |
| **Doručování a předešlý stav** | § 56, § 56a, § 56b, § 57 | Modifikace OSŘ + ohlašovna + vyloučení uvedení v předešlý stav |
...
**Pět klíčových principů** zahájení:

1. **Návrhové řízení** (odst. 1) — exekuce **nezačne sama od sebe**. I když existuje vykonatelný titul, věřitel musí podat návrh. To se liší od některých výkonů, kde stát zahajuje sám (např. trestní pokuta — celní úřad vymáhá).

2. **Okamžik zahájení = doručení návrhu exekutorovi s časovým razítkem** (odst. 2) — s přesností **na minutu**. To je důležité pro:
   - **stavení promlčení** (§ 648 OZ — uplatnění práva u orgánu veřejné moci),
   - **pořadí mezi více exekucemi** vůči témuž povinnému,
   - **anti-fraud** (§ 44a — vyrozumění o zahájení).

3. **Odklad zjišťování/zajištění do pověření** (odst. 3) — mezi zahájením a pověřením soudu (max. 15+15 dnů) exekutor **NESMÍ aktivně lustrovat ani zajišťovat** majetek povinného. Klíčová ochrana před zneužitím — exekutor by nemohl, kdyby chtěl, šokovat povinného blokací účtu, než soud rozhodne.

4. **Priorita prvního zápisu v RZE** (odst. 4) — pokud oprávněný (např. omylem) podá více návrhů u různých exekutorů na **tutéž věc** (= stejný titul, stejné plnění), exekuci vede ten, kdo je v rejstříku zapsán první. Ostatní exekuce se zastaví. Anti-multiplikace.

5. **Vyloučení procesních institutů** (odst. 5):
   - **Přerušení řízení** nelze (jen výjimečně podle zvláštních předpisů — typicky § 109 IZ).
   - **Prominutí zmeškání lhůty** nelze (§ 58 OSŘ se nepoužije — striktní lhůty).
   - **Obnova řízení** nelze (§ 228 OSŘ se nepoužije).
   
   Logika: exekuce má být **rychlá a definitivní** — opravné prostředky jsou redukovány na odvolání, návrh na zastavení a kárnou cestu.

**Souběh s návrhem na prohlášení vykonatelnosti** (odst. 6): u cizích rozhodnutí, kde EU nařízení nezavádí přímou vykonatelnost, je třeba **exequatur** — návrh lze podat **současně s exekučním návrhem**; o exequatur rozhodne exekuční soud (§ 43a odst. 3).

### Vazby a souvislosti

- **§ 38** — náležitosti návrhu.
- **§ 43a** — pověření soudem.
- **§ 35b** — RZE jako evidence.
...
**Klíčová elektronická infrastruktura** — odlišný systém od veřejné **CEE** (§ 125) — RZE je **neveřejný** rejstřík sloužící pro **vnitřní" koordinaci** soudů, exekutorů a Komory:

- **Provozovatel:** ministerstvo (§ 35a odst. 1).
- **Přístup:** pouze soudy a Komora; exekutor jen ke svým vlastním řízením + údaje o exekucích vedených jinými exekutory podle § 35b odst. 1 písm. l, m (přehled o prodeji movitých věcí — anti-duplikace).
- **Doba uchovávání:** 25 let od skončení řízení.

**Údaje v RZE** (14 položek, § 35b odst. 1) — od počátku označení exekutora, exekučního titulu, účastníků, vymáhané povinnosti, přes datum zahájení, výši zálohy, datum **doložky provedení exekuce** (§ 52 odst. 3 — okamžik právní moci usnesení o nařízení), průběh exekuce prodejem movitých, až po datum skončení.

**Funkce RZE:**
- evidence pro soud při rozhodování o pověření (§ 43a),
...
- *NS* [29 Cdo 1947/2021](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/B4C8857DEFCF17A8C1258AA5003C8FCE?openDocument) — kat. A, 31. 10. 2023
...
- *NS* [21 Cdo 1428/2014](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/C6055C892A991BD6C1257E340046042D?openDocument) — kat. A, 26. 2. 2015
...
- *NS* [20 Cdo 1785/2013](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/1415115351EC8A06C1257C2F002D971B?openDocument) — kat. A, 30. 10. 2013
...
- **Oprávněný** — věřitel uvedený v titulu (nebo právní nástupce, doložený listinou),
- **Povinný** — dlužník uvedený v titulu.

**Třetí účastník — manžel povinného** (odst. 2): vstupuje **automaticky**, jakmile:
- je postihován **majetek manžela** (jeho výlučný), nebo
- je postihován **majetek v SJM**.

To je důležité — manžel nemůže být „němým svědkem" exekuce vůči SJM; má **plná procesní práva** (návrh na zastavení podle § 262b OSŘ, vylučovací žaloba podle § 267 OSŘ, námitka podjatosti, atd.).

**Přechod práv/povinností** (odst. 3—4): pokud věřitel zemřel/byl převzat/postoupil pohledávku, nový oprávněný **prokáže** listinou — typicky:
- dědické usnesení o nabytí dědictví,
- smlouva o postoupení pohledávky (s ověřenými podpisy),
- usnesení o převzetí dluhu / splynutí osob,
- veřejná listina o převodu závodu.
...
- *NS* [21 Cdo 2600/2014](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/0E3BCC1D6BDEBC79C1257D4000344C56?openDocument) — kat. A, 29. 7. 2014
...
- *NS* [21 Cdo 828/2014](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/9E4F793F41FE0C1DC1257D00003505BC?openDocument) — kat. A, 29. 5. 2014
...
- vykonatelné soudní rozhodnutí o peněžitém i nepeněžitém plnění (vyklizení, odebrání věci, atd.),
- výživné na nezletilé (i když to je „péče o nezletilé" — výslovná výjimka),
- cizí rozhodnutí po prohlášení vykonatelnosti nebo s přímou vykonatelností (Brusel I bis, Maintenance, atd.),
- cizí rozhodčí nálezy s uznáním podle ZRŘ.

**Co NEJDE (vyloučené z EŘ):**
- **Rozhodnutí o péči o nezletilé** (kromě výživného) — výkon vede **soud** podle § 502 a násl. ZŘS (pokuta, odnětí dítěte, atd.).
- **Rozhodnutí o ochraně před domácím násilím** (§ 76b OSŘ a navazující ZŘS) — exekuce by zde nedávala smysl; vykáno se vykonává policejně.
- **Rozhodnutí orgánů EU** — typicky pokuty Komise; vymáhá se podle nařízení EU + národní úprava.
- **Cizí rozhodnutí bez prohlášení vykonatelnosti** — nejprve musí proběhnout exequatur, pak teprve exekuce.

**Spojování exekucí — odst. 5—7:**

| Spojení | Kdo / kdy | Důsledek |
|---|---|---|
| **§ 37 odst. 5** — automatické | další návrh oprávněného proti témuž povinnému u téhož exekutora | spojení ke společnému řízení, ode dne podání |
| **§ 37 odst. 6** — na návrh povinného | více exekucí proti témuž povinnému u různých exekutorů, bagatelní povaha (≤ 50 000 Kč podle § 202/2 OSŘ), alespoň 2 řízení, oprávněným je věřitel věřitelské pohledávky | exekuční soud spojí; v usnesení určí vedoucího exekutora |
...
- *NS* [20 Cdo 912/2005](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/A5B1CD915DD1E301C1257A4E0067CB4C?openDocument) — kat. A, 7. 2. 2006
...
**Tři okruhy povinných údajů:**

1. **Identifikace exekutora** — kdo má vést.
2. **Identifikace navrhovatele** — kdo podává, podpis, datum.
3. **Identifikace věci** — kdo jsou účastníci (jméno, pobyt, RČ/IČO), který titul, jaká povinnost, kolik bylo dosud splněno, případné důkazy.

**Povinné přílohy:**
- **Originál nebo úředně ověřená kopie** exekučního titulu **s doložkou vykonatelnosti**,
- u notářského zápisu — **stejnopis** sepsaný notářem,
...
**Tři způsoby ukončení návrhu před pověřením:**

| Procesní úkon | Kdy | Charakteristika |
|---|---|---|
| **Výzva k opravě / doplnění** (odst. 1) | vady, nesrozumitelnost, neurčitost (rušitelné) | 15 dnů, lhůta exekutorem |
| **Odmítnutí** (odst. 2) | neopravené vady **nebo chybějící titul** | usnesení, opravný prostředek = odvolání |
| **Zamítnutí** (odst. 3) | věcné předpoklady nesplněny (např. titul je již zaniklý) | nejpozději ve lhůtě 15 dnů pro pověření, usnesení |
...
- *NS* [21 Cdo 174/2014](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/B6D9CECB5384DF75C1257CAD003EF34D?openDocument) — kat. A, 18. 3. 2014
...
- *NS* [21 Cdo 3266/2013](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/4244A8161D2CAC1CC1257CB5003A7765?openDocument) — kat. A, 25. 3. 2014
...
| Písm. | Titul | Příklad | Vystavující orgán |
|---|---|---|---|
| a) | Rozhodnutí soudu / exekutora | Civilní rozsudek, platební rozkaz, dohoda schválená soudem, **příkaz k úhradě nákladů exekuce** | Civilní soud, exekutor |
| b) | Rozhodnutí soudu / orgánu trestního řízení | Trestní rozsudek o náhradě škody, **peněžitý trest**, propadnutí majetku | Trestní soud, SZ |
| c) | Rozhodčí nález | Nález rozhodčího soudu (vč. mezinárodního) | Rozhodčí senát |
| d) | Notářský zápis se svolením k vykonatelnosti | § 71b NotŘ — typicky dohoda o splátkách s ujednáním vykonatelnosti | Notář |
| e) | Rozhodnutí orgánu veřejné moci | Daňový výměr, sociální nedoplatek, správní pokuta, rozhodnutí ČTÚ, OS přestupek | Správní úřad, daňový orgán |
| f) | Jiná vykonatelná rozhodnutí | Evropský exekuční titul, evropský platební rozkaz, evropské smírčí dohody, **exekutorský zápis se svolením k vykonatelnosti** (§ 71b EŘ) | Různé (specifikováno zvláštními zákony) |

**Lhůta plnění (odst. 2)**: pokud titul neuvádí lhůtu:
- **3 dny** standardně,
- **15 dnů** u vyklizení bytu (od právní moci) — sociální ochrana.

**Dělitelné plnění a více povinných (odst. 3)**: pokud titul neurčuje jinak, **rovným dílem** — nikoli solidárně. Pokud má být plnění solidární, **musí to titul výslovně uvádět** („společně a nerozdílně").
...
Krátký, ale praktický paragraf. Doložku vyznačuje:
- **Soud** — u soudních rozhodnutí,
- **Orgán činný v trestním řízení** — u trestních titulů,
- **Rozhodčí senát** — u rozhodčích nálezů,
- **Správní úřad** — u správních titulů,
...
## § 42 — SJM a Seznam listin o manželském majetkovém režimu
...
- *NS* [20 Cdo 2610/2009](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/7A7A9FEA6876F9CBC1257A4E0068DF0C?openDocument) — kat. A, 30. 3. 2011
...
- *NS* [20 Cdo 5160/2017](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/4A1F04DEBCBA07B8C1258267003C4281?openDocument) — kat. A, 23. 1. 2018
...
- *NS* [31 Cdo 4087/2013](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/23788231EE7F9698C1257F70004C6B9F?openDocument) — kat. A, 9. 12. 2015
...
**Seznam listin o manželském majetkovém režimu** (zkráceně „**Seznam listin**", vedený Notářskou komorou podle § 35a a násl. NotŘ) eviduje:
- smlouvy o **úpravě SJM** (zúžení, rozšíření, výlučnost),
- rozhodnutí soudu o **zrušení / obnovení / zúžení SJM**,
- dohody a rozhodnutí o **změně režimu**.

**Logika pravidla:**
- Manželé mohou vlastním smluvním rozhodnutím změnit zákonný režim SJM (§ 716 a násl. OZ),
- ale **vůči věřiteli** je tato změna **účinná jen** od zápisu do Seznamu listin (publicita),
- věřitel, jehož pohledávka **vznikla před zápisem**, je chráněn — exekutor postihne SJM v původní podobě.

**Praktický scénář:** Manželé v r. 2024 zúží SJM smlouvou (např. nemovitost přejde výhradně do vlastnictví manželky). Zápis do Seznamu listin v r. 2024. V r. 2025 dlužní manžel poruší závazek z r. 2022 (před zápisem) — exekutor postihne i nemovitost v Seznamu jako součást SJM. Naopak závazek z r. 2025 (po zápisu) by se nemovitosti netýkal.

**Anti-fraud — domněnka (odst. 2 in fine):** „nelze-li zjistit, že závazek vznikl po zápisu, **má se za to, že vznikl před zápisem**" — chrání věřitele před pozdějšími manipulacemi.
...
Standardní paralela § 263 OSŘ — pro exekuci podmíněného plnění (např. „povinný zaplatí, jakmile oprávněný odevzdá věc") musí **oprávněný prokázat** splnění podmínky **kvalifikovanou listinou**:
- státním orgánem (úřad, soud),
...
**Klíčový procesní krok**, který od novely 2009/286 Sb. nahradil dřívější **usnesení o nařízení exekuce**:

**Časový rámec — celkem max. 30 dnů:**
- exekutor podává žádost o pověření **do 15 dnů** od přijetí návrhu,
- soud vydává pověření / pokyn k zamítnutí **do 15 dnů** od žádosti.

**Co je pověření:**
- **NENÍ soudním rozhodnutím** (odst. 5) — proto se proti němu nedá odvolat, neexistuje opravný prostředek,
- **NEDORUČUJE se účastníkům** — jen exekutorovi,
- ale je to **právní akt** s konstitutivními účinky — od pověření exekutor smí zjišťovat majetek a vydat exekuční příkaz (§ 35 odst. 3, § 47 odst. 1).

**Obsah pověření (odst. 4)**:
- označení soudu, exekutora, titulu, účastníků,
- označení vymáhané povinnosti vč. nákladů,
- podpis a datum.

**Pokyn k odmítnutí / zamítnutí / zastavení (odst. 6)**: soud místo pověření udělí exekutorovi pokyn. Důvody:
- nedoložení titulu,
- titul není vykonatelný,
- pohledávka už zanikla (z titulu samotného nebo z dokladů přiložených k návrhu),
- nedostatek pravomoci exekuce (např. titul o péči o nezletilé).

**Exekutor je pokynem VÁZÁN** — vydá usnesení o odmítnutí / zamítnutí / zastavení podle pokynu. Proti tomuto usnesení **lze odvolání** (§ 55c).
...
- *NS* [31 Cdo 4545/2008](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/D5046A62AB37D41BC1257A4E00696B45?openDocument) — kat. A, 9. 3. 2011
...
**Vyrozumění** plní **trojí funkci**:
1. **Informativní** — povinný se dozví o zahájení exekuce, výši vymáhané pohledávky, kdo ji vede,
2. **Procesní** — od doručení běží **30denní výzva ke splnění** (§ 46 odst. 6) a **15denní lhůta pro námitku podjatosti** (§ 29 odst. 5),
3. **Konstitutivní** — od doručení nastupuje **generální inhibitorium** (§ 44a) — zákaz dispozic povinného s majetkem.

**Časový rámec:**
- Oprávněnému — do 15 dnů od pověření,
- Povinnému — **s prvním exekučním příkazem** (typicky srážky ze mzdy nebo blokace účtu).
...
**Generální inhibitorium** je **jedno z nejmocnějších oprávnění exekutora** — od okamžiku doručení vyrozumění povinný **NESMÍ disponovat** se svým majetkem:

**Zakázané dispozice:**
- prodej, darování, směna nemovitostí, vozidel, cenných papírů, podílů,
- převod účtu, vyplacení vkladů,
- vzdání se práv (např. dědického nároku),
- nakládání s majetkem v SJM (i nedlužným manželem!),
- zatížení majetku (zástavní právo, věcné břemeno).

**Povolené výjimky:**
- **běžná obchodní a provozní činnost** — povinný-podnikatel může dál nakupovat a prodávat zboží (jinak by inhibitorium zničilo podnikání),
- **základní životní potřeby** — pro povinného a osoby s vyživovací povinností (jídlo, bydlení, léky),
- **udržování a správa majetku** — typicky platba nájmu, energií, oprav.

**Sankce za porušení (odst. 1 věta druhá):** porušující právní jednání je **neplatné**, ale jde o **relativní neplatnost** (odst. 1 věta třetí) — musí ji vznést:
- exekutor,
- oprávněný,
- přihlášený věřitel.

Pokud žádný z nich neplatnost nevznese, jednání je platné. Logika: chrání **dobrověrného nabyvatele**, pokud věřitel později nezareaguje.

**Možnosti povinného (odst. 2—4):**
- **složit jistinu** = inhibitorium se zruší rozhodnutím (lhůta 7 dnů),
- **návrh na zúžení inhibitoria** (odst. 3) — pokud zbývající majetek zjevně postačuje k uhrazení,
- **dobrovolné zpeněžení s písemným souhlasem** exekutora, oprávněného a věřitelů (odst. 4) — povinný sám prodá majetek za obvyklou cenu, výtěžek jde exekutorovi.

**Výjimka pro stát a obce (odst. 5)** — stát a územní samospráva nepodléhají inhibitoriu (jejich majetek je veřejnoprávně chráněn jinak; nebylo by ani prakticky možné jim zakázat dispozice).

### Vazby a souvislosti

- **§ 47 odst. 6** — speciální inhibitorium k majetku označenému v exekučním příkazu (užší).
...
**Dvě cesty:**
1. **Konsensuální** (odst. 1) — pokud souhlasí oprávněný + původní exekutor + nový exekutor. Bez zásahu soudu.
2. **Soudní** (odst. 2) — pokud původní exekutor odmítá (např. ekonomický důvod — chce dokončit vymáhání). Soud rozhodne po jeho vyjádření; oprávněný musí prokázat **důvodnost** návrhu.

**Účinky původního návrhu zůstávají** (odst. 3) — stavení promlčení, datum zahájení, ostatní procesní úkony, nepadají.

**Nákladová stránka:**
- původní exekutor dostane odměnu **jako při zastavení** (= minimální odměna podle vyhl. 330/2001 Sb., § 11),
- náklady přechodu jdou na **vrub oprávněného** (odst. 5).
...
- *NS* [31 Nd 200/2012](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/57512C4CD90CD53DC1257A78002EEDD6?openDocument) — kat. A, 12. 9. 2012
...
**Princip — actor sequitur forum rei** (žalobce následuje sídlo žalovaného):
- věcně **okresní soud** (žádný krajský — i u milionových pohledávek),
- místně **bydliště / sídlo povinného**,
- u zahraničních povinných **kde má majetek**,
- u kolize — **abecedně první** soud (odst. 3).

Tato pravidla určují **exekuční soud** podle § 45 — soud, který:
- vydává **pověření** (§ 43a),
...
- *NS* [30 Cdo 3359/2022](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/4E5DDC20D529E611C125898E004F7385?openDocument) — kat. A, 17. 1. 2023
...
- *NS* [30 Cdo 2082/2015](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/AC0D79A1CD65F8D8C1257FE30025E50E?openDocument) — kat. A, 10. 5. 2016
...
- *NS* [29 ICdo 5/2014](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/AC498E6A83D5C1B9C1257F77002B57A9?openDocument) — kat. A, 22. 12. 2015
...
- *NS* [31 Cdo 2827/2012](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/67BC5DA99B56C7B0C1257E8F0025EF2A?openDocument) — kat. A, 20. 5. 2015
...
**Centrální procesní paragraf** — pravidla výkonu exekuce:

**1. Rychlost a účelnost (odst. 1)** — generální klauzule; pomalost a neúčelnost = porušení povinnosti → kárná odpovědnost.

**2. Officialita (odst. 2)** — exekutor postupuje **i bez návrhu** (na rozdíl od soudu, který je vázán dispozičním principem v civilním sporu). Iniciativa = exekutor.

**3. Princip FIFO (odst. 3)** — exekuce v pořadí, jak došly návrhy. Anti-favoritismus.

**4. Zvláštní účet (odst. 5)** — **klíčové ochranné opatření** po skandálech zpronevěr z 2010-2015. Vymožené plnění **se nesmí mísit** s vlastními prostředky exekutora. Účet podléhá dohledu MS i Komory (§ 7 odst. 1).

**5. Výplata oprávněnému (odst. 4)**: **30 dnů** od přijetí, po odpočtu nákladů exekuce. Částečné plnění nad 1 000 Kč se vyplácí stejnou lhůtou. Z účtu se vyplácí i s úroky.

**6. Klíčová „30denní lhůta na dobrovolné splnění" (odst. 6)** — jedno z nejvýhodnějších ustanovení pro povinného:

| Pokud povinný do 30 dnů... | Důsledek |
|---|---|
| ...zaplatí jistinu + sníženou zálohu na náklady | exekuce **provedena**, zákaz dispozic (§ 44a + § 47/6) **zaniká**, exekutor vydá **snížený příkaz k úhradě nákladů** (§ 11 vyhl. 330/2001 — odměna max. 32 250 Kč, paušál 1 750 Kč) |
| ...nezaplatí | exekutor provádí exekuci v plném rozsahu (vyšší odměna + paušál 3 500 Kč) |

To je **finanční páka** pro motivaci k dobrovolnému plnění — povinný ušetří **až 50 % nákladů**, pokud jedná rychle.

**7. Insolvence (odst. 7)** — pokud je exekuce přerušena (§ 109 IZ), exekutor nečiní úkony, kterými se exekuce provádí (zajištění je možné). Po prohlášení úpadku **vydá vymožené plnění do podstaty** po odpočtu nákladů (§ 167 IZ).
...
- *NS* [29 ICdo 47/2013](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/8E8DE1FC65B2D582C1257F5A003BF4F3?openDocument) — kat. A, 30. 11. 2015
...
- *NS* [31 Cdo 2827/2012](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/67BC5DA99B56C7B0C1257E8F0025EF2A?openDocument) — kat. A, 20. 5. 2015
  > „Nebyla-li vymáhaná povinnost splněna z prostředků získaných postižením členských práv a povinností, členství v družstvu, zaniklé v důsledku exekuce postihující členská práva a povinnosti, se obnoví, zaniknou-li účinky exekučního příkazu, jímž byly členská práva a povinnosti postiženy"
- *NS* [25 Cdo 4802/2008](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/4902AC5D3C65EA43C1257A4E0066C833?openDocument) — kat. A, 30. 11. 2010
...
**Exekuční příkaz** je **klíčové meritorní rozhodnutí exekutora** — určuje, **jakou cestou** se bude vymáhat.

**Klíčové vlastnosti:**

1. **Volba způsobu (odst. 1):** exekutor volí ze způsobů uvedených v Hlavě IV (§ 58—73) — viz kapitola 05. Zákaz „zřejmě nevhodného" způsobu = **proporcionalita** (např. dražba domu za 5 mil. Kč pro pohledávku 5 000 Kč by byla zjevně nepřiměřená; vhodnější je srážka ze mzdy).

2. **Účinky = nařízení výkonu rozhodnutí podle OSŘ (odst. 2)** — exekuční příkaz **nahrazuje** usnesení soudu o nařízení výkonu podle § 251 a násl. OSŘ. Doručením příkazu se vztahují všechny účinky výkonu na konkrétní majetek.

3. **Odložená provedení (odst. 2 písm. a—e)** — pět skutečností, které musí nastat **PŘED** provedením:
   - uplynutí 30denní lhůty na dobrovolné plnění,
   - vyřízení návrhu na zastavení (pokud byl podán v lhůtě),
   - vyřízení návrhu na exequatur,
   - **zápis doložky provedení exekuce do RZE** — moment, kdy je „povolena" provedení,
   - **právní moc samotného EP** (15denní lhůta odvolání není přípustná, ale lhůta pro právní moc plyne odjinud — § 55c odst. 3 vylučuje odvolání proti EP, ale právní moc = doručení + neexistence opravného prostředku).

4. **Trestní zajištění (odst. 4)** — pokud na majetku váznou trestní účinky (§ 79a TŘ — zajištění výnosů z trestné činnosti), exekutor musí získat **předchozí souhlas** orgánu trestního řízení (SZ / vyšetřovatel / soud).

5. **Bez opravného prostředku (odst. 5)** — proti EP **NELZE ODVOLAT**. To je důležité — povinný musí napadnout EP cestou **návrhu na zastavení** (§ 55) nebo cestou **vyloučení věci** (§ 267 OSŘ — vylučovací žaloba třetí osoby).

6. **Speciální inhibitorium (odst. 6)** — užší než generální (§ 44a); zákaz dispozic jen s konkrétně postiženým majetkem. Sankce: neplatnost (§ 580 OZ).
...
## § 49 — Variace exekučního příkazu podle způsobu

Detailně specifikuje, **co musí být ve výroku EP** podle zvoleného způsobu:

| Způsob | Specifické označení |
|---|---|
| **Srážky ze mzdy** | plátce mzdy, případně úhrada jeho nákladů |
| **Přikázání pohledávky z účtu** | banka, číslo účtu, pořadí účtů |
| **Přikázání jiné pohledávky** | dlužník povinného |
| **Postižení jiných majetkových práv** | určení práva (podíl v s.r.o., členství v družstvu, autorská práva) |
| **Prodej movitých** | konkrétní věci nebo „všechny postižitelné" |
| **Prodej nemovité věci** | nemovitost |
| **Postižení závodu** | závod nebo část / podíl |
| **Pozastavení řidičského oprávnění** | série a číslo ŘP |
...
Exekutor může:
- **vyzvat oprávněného**, aby navrhl způsob provedení a označil plátce mzdy / dlužníka / účet,
...
Pověření zaniká:
- a) vyloučením exekutora,
- b) zastavením exekuce,
- c) **vymožením** pohledávky + nákladů,
...
**Klíčové ustanovení o subsidiaritě OSŘ:**

- **OSŘ se použije přiměřeně, ne odkazem** — exekutor musí posoudit, zda konkrétní úprava OSŘ je s EŘ slučitelná,
...
- ochrana před šikanózními výhrůžkami a vymáháním nátlakem,
...
| Typ | Podmínka |
|---|---|
| **§ 54 odst. 5** | odložena vykonatelnost titulu (jiným řízením) |
| **§ 54 odst. 6** | povinný **složí jistinu** = inhibitorium se zruší, exekuce čeká na rozhodnutí o návrhu na zastavení |
| **§ 54 odst. 7** | **NOVÝ INSTITUT** (od 2021/286 Sb.) — **odklad prodeje movitých při paralelních srážkách** |
| **§ 266 OSŘ** | obecné důvody (např. zdravotní stav povinného) |
| **§ 54 odst. 11** | **bez návrhu** — lze očekávat zastavení |

**Klíčový § 54 odst. 7—10 — alternativa k mobilní prohlídce:**

- Pokud je vedena exekuce **srážkami ze mzdy** + **prodejem movitých**, exekutor **odloží prodej movitých**, pokud povinný:
  - oznámí to **písemně bez zbytečného odkladu** po soupisu,
  - bude **měsíčně zasílat na zvláštní účet** druhou třetinu zbytku čisté mzdy z exekuce srážkami (min. 1 500 Kč),
- u povinného **bez probíhající srážky** (typicky důchodce, OSVČ) — postačí slíbit zasílání 1 500 Kč/měsíc.
- **Limit:** přesahuje-li cena soupisu **36násobek měsíční částky**, odklad se nepoužije / zruší (odst. 10).
- Pravidlo se použije **nejvýše jednou** v rámci téže exekuce.

**Smysl:** ochrana povinného před exekučním utopením v podobě mobilní prohlídky a dražby movitých věcí, pokud reálně platí ze mzdy.
...
- *NS* [21 Cdo 3439/2013](https://rozhodnuti.nsoud.cz/Judikatura/judikatura_ns.nsf/WebSearch/72EB38D0BFCA5236C1257C9E004D24AD?openDocument) — kat. A, 20. 2. 2014
...
- pohledávka **zanikla** (splacením, započtením, prominutím, promlčením),
- exekuce směřuje na věc **vyloučenou** z exekuce (§ 322 OSŘ),
- výtěžek **nepokryje** náklady exekuce,
- právo třetí osoby na věc (§ 267 OSŘ),
- jiná nepřípustnost.

**Procesní rysy:**
- **lhůta 15 dnů** od dozvědění se o důvodu,
- exekutor **vyzývá ostatní účastníky** k vyjádření do 15 dnů,
- souhlas všech → exekutor zastaví do 30 dnů,
- nesouhlas → exekutor předkládá soudu.

### Zastavení po 6 letech bezvýslednosti (odst. 7—13) — **klíčová novela 2021/286 Sb.**
...
**Princip:**
- pokud po **6 letech od doložky provedení exekuce** nedošlo k **žádnému** plnění (ani částečnému) a není postižena **nemovitost**, lze exekuci „**utopit**",
- exekutor vyzve oprávněného → ten může:
  - souhlasit se zastavením → konec,
  - **složit zálohu na další vedení** (odst. 8) → exekuce pokračuje další **3 roky** (odst. 11),
  - nereagovat → konec,
- výjimky (odst. 9) **bez zálohy**: výživné nezletilého, náhrada újmy poškozenému (TČ, pracovní úraz), bezdůvodné obohacení, školné, dobré mravy.

**Maximální doba** trvání bezvýsledné exekuce **12 let** (odst. 11 in fine) — po 12 letech musí být zastavena.

**Lhůta neběží (odst. 12):**
- u nepeněžitého plnění,
- po dobu probíhajícího řízení o návrhu (zastavení, podjatost, odklad, odvolání),
- po dobu jiného odkladu / nezpůsobilosti.

**Náklady zastavení** (odst. 13): minimální odměna + paušál hradí oprávněný (ze zálohy); přesah zaniká.

### Vazby a souvislosti

- **§ 268 OSŘ** — důvody zastavení.
...
**Klíčový opravný prostředek**:
- Odvolává se **u exekutora** (= u prvního stupně),
- **Rozhoduje krajský soud** v obvodu exekučního soudu,
- **Lhůta 15 dnů** od doručení,
- Postup podle **§ 201—226 OSŘ** přiměřeně.

**Vyloučení odvolání** (odst. 3) je významné — nelze se odvolat:
- proti **exekučnímu příkazu** (jediná cesta = návrh na zastavení),
- proti **změně/zrušení EP**,
...
## § 56a — Doručování na ohlašovnu (novela 2021/286 Sb.)

**Specifický režim** pro osoby s **trvalým pobytem na ohlašovně** (typicky obecní úřad — sociálně slabší skupina, bezdomovci, atd.):

- exekutor **NEdoručuje** poštou,
- **uloží písemnost u sebe** + **zveřejní výzvu na centrální úřední desce** (§ 125a),
- adresát má **10 dnů** na vyzvednutí nebo žádost o doslání,
- po 10 dnech — **fikce doručení**.

**Výjimky** (odst. 4): vyrozumění o zahájení, písemnosti vyzvednuté v úložní době, písemnosti s vyloučenou fikcí, EP dlužníku povinného. Tyto se doručují standardně.
...
## § 57 — Vyloučení uvedení v předešlý stav
...
## Shrnutí Hlavy III Dílu 2

| Klíčové ustanovení | Obsah |
|---|---|
| § 35 | Návrhové řízení, datum + minuta zahájení, max. 15+15 dnů na pověření |
| § 36 | Účastníci: oprávněný + povinný + manžel u SJM, přechod práv jen veřejnou listinou |
| § 37 | Co lze do EŘ, co ne (péče o nezletilé, ochrana před DV, EU pokuty); spojování exekucí |
| § 38—39 | Náležitosti návrhu; výzva k opravě (15 dnů), odmítnutí / zamítnutí / zastavení |
| § 40 | **6 typů exekučních titulů** (taxativní) |
| § 41 | Doložka vykonatelnosti — vystavující orgán |
| § 42 | SJM + Seznam listin (publicita); účet manžela jen 1× |
| § 43a | **Pověření soudem** — 15+15 dnů, ne soudní rozhodnutí, bez doručení účastníkům |
| § 44 | Vyrozumění o zahájení — do vlastních rukou, spouští 30denní lhůtu + inhibitorium |
| § 44a | **Generální inhibitorium** — zákaz dispozic s majetkem (vyjma běžné činnosti, životních potřeb, správy); relativní neplatnost; zánik složením jistoty; nepoužije se na stát |
| § 44b | Změna exekutora — konsensuálně nebo soudem; náklady jdou na oprávněného |
| § 45 | **Místně příslušný okresní soud** podle bydliště/sídla povinného |
| § 46 | Postup rychle a účelně, FIFO, **zvláštní účet**, výplata oprávněnému 30 dnů, **30denní lhůta na dobrovolné splnění s nižšími náklady** |
| § 47 | **Exekuční příkaz** — volba způsobu, proporcionalita, účinky výkonu rozhodnutí, **bez opravného prostředku**, speciální inhibitorium |
| § 49 | Specifika EP podle způsobu provedení + datové přílohy |
| § 52 | **Subsidiarita OSŘ** + definice doložky provedení exekuce |
| § 53 | Povinný **záznam telefonních hovorů** |
| § 54 | **Odklad** — 7 typů důvodů; novela 2021/286 Sb. = **alternativa k prodeji movitých při srážkách** (zasílat 1 500 Kč/měsíc) |
| § 55 | **Zastavení**: klasické (15 dnů, § 268 OSŘ), **po 6 letech bezvýslednosti** (možnost prodloužení o 3 + 3 roky, max. 12 let) |
| § 55a | Soud nezastaví, dokud nejsou zaplaceny náklady |
| § 55c | **Odvolání** ke krajskému soudu, 15 dnů; **vyloučeno proti EP, příkazu k úhradě nákladů, vyškrtnutí věci, změně/zrušení EP** |
| § 56—56b | Doručování + speciální režim u ohlašovny + zveřejnění na centrální úřední desce |
| § 57 | **Uvedení v předešlý stav vyloučeno** |

**Klíčové ekonomicko-procesní pravidlo** Dílu 2 — **30denní lhůta na dobrovolné splnění s nižšími náklady** (§ 46 odst. 6): povinný motivovaný uspořit ~50 % nákladů exekuce má silnou pobídku k rychlému plnění. Toto pravidlo + **generální inhibitorium** (§ 44a) tvoří **dvojklíč" účinnosti českého exekučního systému.

V další **Hlavě IV** (§ 58—73) následuje katalog **konkrétních způsobů provedení exekuce** — srážky ze mzdy, přikázání pohledávky z účtu, prodej movitých, prodej nemovitých, postižení závodu, zřízení exekutorského zástavního práva, vyklizení, odebrání věci.
